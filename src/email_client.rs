...
impl EmailClient {
    pub fn new(base_url: String
        , sender: SubscriberEmail, authorization_token: Secret<String>) -> Self {
        Self {
...
mod tests {
    ...
    async fn send_fires_a_request_to_base_url() {
        ...
        let email_client = EmailClient::new(mock_server.uri(),
            sender, Secret::new(Faker.fake()));
        ...
        let _ = email_client.send_email(subscriber_email,
